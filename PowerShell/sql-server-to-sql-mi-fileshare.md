...
- *ResourceGroupName*: Resource group in which Azure SQL Managed Instance is present.  
- *TargetDatabaseName*: The name of the migrated database in Azure SQL Managed Instance.
...
- *MigrationService*: Resource Id of the Database Migration Service that will be used to orchestrate the migration. The migration service should be in the same region as Azure SQL Managed Instance.
- *SourceDatabaseName*: Name of the source database that is being migrated to Azure SQL Managed Instance.
